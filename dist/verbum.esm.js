...
class MentionNode extends TextNode {
  constructor(mentionName, popover, text, key) {
    super(text != null ? text : mentionName, key);

    this.removePopover = () => {
      var existingPopover = document.getElementById(this.__popoverCard.card.id);
...
function $createMentionNode(mentionName, popover) {
  var mentionNode = new MentionNode(mentionName, popover);
 ...
 *
 */
var PlaygroundNodes = [HeadingNode, ListNode, ListItemNode, QuoteNode, CodeNode, TableNode, TableCellNode, TableRowNode, HashtagNode, CodeHighlightNode, AutoLinkNode, LinkNode, OverflowNode, PollNode, StickyNode, ImageNode, MentionNode, EmojiNode, TypeaheadNode, KeywordNode, HorizontalRuleNode, TweetNode, YouTubeNode, MarkNode, CustomFieldNode];
...
var PLAYGROUND_TRANSFORMERS = [TABLE, HR, IMAGE, TWEET, CHECK_LIST, ...ELEMENT_TRANSFORMERS, ...TEXT_FORMAT_TRANSFORMERS, ...TEXT_MATCH_TRANSFORMERS];
...
var Editor = _ref => {
  ...
  }, /*#__PURE__*/React__default.createElement(AutoFocusPlugin, null), /*#__PURE__*/React__default.createElement(ClearEditorPlugin, null), hashtagsEnabled && /*#__PURE__*/React__default.createElement(HashtagPlugin, null), emojisEnabled && /*#__PURE__*/React__default.createElement(EmojisPlugin, null), /*#__PURE__*/React__default.createElement(KeywordsPlugin, null), /*#__PURE__*/React__default.createElement(SpeechToTextPlugin$1, null), /*#__PURE__*/React__default.createElement(DragDropPaste, null), autoLinkEnabled && /*#__PURE__*/React__default.createElement(LexicalAutoLinkPlugin, null), /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(RichTextPlugin, {
...
var InsertDropdown = _ref8 => {
  ...
  var [modal, showModal] = useModal();
  return /*#__PURE__*/React__default.createElement("div", null, enableTable && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(TablePlugin, null), /*#__PURE__*/React__default.createElement(TableActionMenuPlugin, null), /*#__PURE__*/React__default.createElement(TableCellResizerPlugin, null)), enableYoutube && /*#__PURE__*/React__default.createElement(YouTubePlugin, null), enableTwitter && /*#__PURE__*/React__default.createElement(TwitterPlugin, null), enablePoll && /*#__PURE__*/React__default.createElement(PollPlugin, null), enableImage.enable && /*#__PURE__*/React__default.createElement(ImagesPlugin, {
...
function getPossibleMenuTextMatch(text) {
  var match = checkForAtSignMentions(text, 1);
  return match === null ? checkForCapitalizedNameMentions(text, 3) : match;
}

class MentionMenuOption extends MenuOption {
  constructor(name, picture, url, userCard) {
    super(name);
    this.name = name;
...
function MentionsPlugin(props) {
  ...
  var options = useMemo(() => results.map(result => new MentionMenuOption(getTypeaheadValues(result).value, getTypeaheadValues(result).picture, getTypeaheadValues(result).url, {
    card: getTypeaheadValues(result).popoverCard.card(result),
    offset: {
      leftOffset: getTypeaheadValues(result).popoverCard.offset.leftOffset,
      topOffset: getTypeaheadValues(result).popoverCard.offset.topOffset
    }
  ...
  var onSelectOption = useCallback((selectedOption, nodeToReplace, closeMenu) => {
    editor.update(() => {
      if (nodeToReplace) {
        ...
        var staticElement = renderToStaticMarkup(selectedOption.userCard.card);
  ...
  var checkForMentionMatch = useCallback(text => {
    var mentionMatch = getPossibleMenuTextMatch(text);
