...
var Editor = _ref => {
  ...
  }, /*#__PURE__*/React__default.createElement(LexicalAutoFocusPlugin.AutoFocusPlugin, null), /*#__PURE__*/React__default.createElement(LexicalClearEditorPlugin.ClearEditorPlugin, null), hashtagsEnabled && /*#__PURE__*/React__default.createElement(LexicalHashtagPlugin.HashtagPlugin, null), emojisEnabled && /*#__PURE__*/React__default.createElement(EmojisPlugin, null), /*#__PURE__*/React__default.createElement(KeywordsPlugin, null), /*#__PURE__*/React__default.createElement(SpeechToTextPlugin$1, null), /*#__PURE__*/React__default.createElement(DragDropPaste, null), autoLinkEnabled && /*#__PURE__*/React__default.createElement(LexicalAutoLinkPlugin, null), /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(LexicalRichTextPlugin.RichTextPlugin, {
...
class MentionMenuOption extends LexicalTypeaheadMenuPlugin.MenuOption {
...
function MentionsPlugin(props) {
  ...
  var options = React.useMemo(() => results.map(result => new MentionMenuOption(getTypeaheadValues(result).value, getTypeaheadValues(result).picture, getTypeaheadValues(result).url, {
  ...
  var onSelectOption = React.useCallback((selectedOption, nodeToReplace, closeMenu) => {
    editor.update(() => {
      if (nodeToReplace) {
        ...
        var staticElement = server.renderToStaticMarkup(selectedOption.userCard.card);
